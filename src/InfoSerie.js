    ...
    return(
        <div>
            ...
            </div>
            {
                ...
                <div className="container">
                    <h1>Ediatr Série</h1>
                    <button onClick={() => setMode("INFO")}  className="btn btn-primary">Cancelar</button>
                    <form>
                    ...
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" value={form.comments} onChange={onChange("comments")} className="form-control"  id="name" placeholder="Comentário"></input>
                        </div>
                        <div className="form-group">
